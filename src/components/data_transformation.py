...
class DataTransformationConfig:
    preprocesser_ob_file_path=os.path.join('artifact',"preprocessor.pkl")
...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        ...
        try:
            ...
            logging.info("num columns scaling completed")
            logging.info("cateogrical columns encoding completed")
    ...
    def initiate_data_transformation(self,train_path,test_path):
        try:
            ...
            logging.info("saved, preprocessing done")
            save_object(
